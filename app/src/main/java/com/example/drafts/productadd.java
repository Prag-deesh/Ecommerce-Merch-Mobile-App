...
public class productadd extends AppCompatActivity {
    ...
    CheckBox recomprod,popprod,newpro;
    Button addprod;
    String pname,pdesc,ptype;
    int pprice;
    public Uri imgUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newpro = findViewById(R.id.isnewproduct);
    ...
    private void saveProductInfotodatabase() {
        ...
        if(recomprod.isChecked())
        {
            prod.put("recommended","yes");
        }
        else
        {
            prod.put("recommended","no");
        }
        if(popprod.isChecked())
        {
            prod.put("popular","yes");
        }
        else
        {
            prod.put("popular","no");
